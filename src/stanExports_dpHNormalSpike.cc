...
#include "stanExports_dpHNormalSpike.h"

RCPP_MODULE(stan_fit4dpHNormalSpike_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_dpHNormalSpike")
