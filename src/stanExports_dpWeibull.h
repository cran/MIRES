...
namespace model_dpWeibull_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_dpWeibull");
    reader.add_event(82, 80, "end", "model_dpWeibull");
    return reader;
}
...
class model_dpWeibull
  : public stan::model::model_base_crtp<model_dpWeibull> {
private:
        int N;
        int K;
        vector_d y;
public:
    model_dpWeibull(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dpWeibull_namespace::model_dpWeibull";
        ...
        try {
            ...
            validate_non_negative_index("shape", "K", K);
            num_params_r__ += K;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("shape", "K", K);
        context__.validate_dims("parameter initialization", "shape", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> shape(K);
        size_t shape_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < shape_j_1_max__; ++j_1__) {
            shape(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0, shape);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 32;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> shape;
            (void) shape;  // dummy to suppress unused var warning
            if (jacobian__)
                shape = in__.vector_lb_constrain(0, K, lp__);
            else
                shape = in__.vector_lb_constrain(0, K);
            current_statement_begin__ = 33;
            ...
            lp_accum__.add(normal_log<propto__>(shape, 0, 3));
            current_statement_begin__ = 47;
            lp_accum__.add(normal_log<propto__>(scale, 0, 2));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    stan::model::assign(lp_y, 
                                stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                                (stan::model::rvalue(lp_y, stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), "lp_y") + weibull_log(get_base1(y, n, "y", 1), get_base1(shape, k, "shape", 1), get_base1(scale, k, "scale", 1))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_dpWeibull_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> shape = in__.vector_lb_constrain(0, K);
        size_t shape_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < shape_j_1_max__; ++j_1__) {
            vars__.push_back(shape(j_1__));
        }
        ...
        try {
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                stan::model::assign(lp_y0, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            (stan::model::rvalue(lp_y0, stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), "lp_y0") + weibull_log(0.0, get_base1(shape, k, "shape", 1), get_base1(scale, k, "scale", 1))), 
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < shape_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "shape" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t scale_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < scale_j_1_max__; ++j_1__) {
...
typedef model_dpWeibull_namespace::model_dpWeibull stan_model;
#ifndef USING_R
