...
namespace model_dpHNormal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_dpHNormal");
    reader.add_event(83, 81, "end", "model_dpHNormal");
    return reader;
}
...
class model_dpHNormal
  : public stan::model::model_base_crtp<model_dpHNormal> {
private:
        int N;
        int K;
        vector_d y;
public:
    model_dpHNormal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dpHNormal_namespace::model_dpHNormal";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_dpHNormal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(py_0, sum(stan::math::exp(lp_y0)));
            }
...
typedef model_dpHNormal_namespace::model_dpHNormal stan_model;
#ifndef USING_R
