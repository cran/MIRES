...
namespace model_dpGauss_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_dpGauss");
    reader.add_event(71, 69, "end", "model_dpGauss");
    return reader;
}
...
class model_dpGauss
  : public stan::model::model_base_crtp<model_dpGauss> {
private:
        int N;
        int K;
        vector_d y;
public:
    model_dpGauss(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dpGauss_namespace::model_dpGauss";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(mu, 0, 3));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    stan::model::assign(lp_y, 
                                stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                                (stan::model::rvalue(lp_y, stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), "lp_y") + normal_log(get_base1(y, n, "y", 1), get_base1(mu, k, "mu", 1), get_base1(sigma, k, "sigma", 1))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_dpGauss_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_dpGauss_namespace::model_dpGauss stan_model;
#ifndef USING_R
