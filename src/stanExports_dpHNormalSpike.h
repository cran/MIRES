...
namespace model_dpHNormalSpike_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_dpHNormalSpike");
    reader.add_event(95, 93, "end", "model_dpHNormalSpike");
    return reader;
}
...
class model_dpHNormalSpike
  : public stan::model::model_base_crtp<model_dpHNormalSpike> {
private:
        int N;
        int K;
        vector_d y;
        double location_spike;
        double sigma_spike;
public:
    model_dpHNormalSpike(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dpHNormalSpike_namespace::model_dpHNormalSpike";
        ...
        try {
            ...
            location_spike = double(0);
            stan::math::fill(location_spike, DUMMY_VAR__);
            stan::math::assign(location_spike,0);
            current_statement_begin__ = 24;
            sigma_spike = double(0);
            stan::math::fill(sigma_spike, DUMMY_VAR__);
            stan::math::assign(sigma_spike,.00001);
            ...
            validate_non_negative_index("location", "K", K);
            num_params_r__ += K;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 35;
        if (!(context__.contains_r("pi_mix")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable pi_mix missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("pi_mix");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "pi_mix", "double", context__.to_vec());
        double pi_mix(0);
        pi_mix = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 1, pi_mix);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable pi_mix: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 38;
        if (!(context__.contains_r("location")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable location missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("location");
        pos__ = 0U;
        validate_non_negative_index("location", "K", K);
        context__.validate_dims("parameter initialization", "location", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> location(K);
        size_t location_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < location_j_1_max__; ++j_1__) {
            location(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0, location);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable location: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 39;
        ...
        pos__ = 0U;
        validate_non_negative_index("scale", "K", K);
        context__.validate_dims("parameter initialization", "scale", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> scale(K);
        size_t scale_j_1_max__ = K;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 35;
            local_scalar_t__ pi_mix;
            (void) pi_mix;  // dummy to suppress unused var warning
            if (jacobian__)
                pi_mix = in__.scalar_lub_constrain(0, 1, lp__);
            else
                pi_mix = in__.scalar_lub_constrain(0, 1);
            current_statement_begin__ = 38;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> location;
            (void) location;  // dummy to suppress unused var warning
            if (jacobian__)
                location = in__.vector_lb_constrain(0, K, lp__);
            else
                location = in__.vector_lb_constrain(0, K);
            current_statement_begin__ = 39;
            ...
            lp_accum__.add(normal_log<propto__>(location, 0, 3));
            current_statement_begin__ = 54;
            lp_accum__.add(exponential_log<propto__>(scale, 5));
            current_statement_begin__ = 56;
            lp_accum__.add(gamma_log<propto__>(alpha, 2, 2));
            current_statement_begin__ = 57;
            lp_accum__.add(beta_log<propto__>(stick_slices, 1, alpha));
            current_statement_begin__ = 59;
            lp_accum__.add(beta_log<propto__>(pi_mix, 1, alpha));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                local_scalar_t__ lp_dp(DUMMY_VAR__);
                (void) lp_dp;  // dummy to suppress unused var warning
                stan::math::initialize(lp_dp, DUMMY_VAR__);
                stan::math::fill(lp_dp, DUMMY_VAR__);
                current_statement_begin__ = 70;
                for (int k = 1; k <= K; ++k) {
                    current_statement_begin__ = 71;
                    stan::model::assign(lp_y, 
                                stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                                (stan::model::rvalue(lp_y, stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), "lp_y") + (normal_log(get_base1(y, n, "y", 1), get_base1(location, k, "location", 1), get_base1(scale, k, "scale", 1)) - normal_ccdf_log(0, get_base1(location, k, "location", 1), get_base1(scale, k, "scale", 1)))), 
                                "assigning variable lp_y");
                }
                current_statement_begin__ = 73;
                stan::math::assign(lp_dp, log_sum_exp(lp_y));
                current_statement_begin__ = 74;
                lp_accum__.add(log_mix(pi_mix, lp_dp, (normal_log(get_base1(y, n, "y", 1), location_spike, sigma_spike) - stan::math::log(.5))));
                }
            }
            }
        } catch (const std::exception& e) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_dpHNormalSpike_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double pi_mix = in__.scalar_lub_constrain(0, 1);
        vars__.push_back(pi_mix);
        Eigen::Matrix<double, Eigen::Dynamic, 1> location = in__.vector_lb_constrain(0, K);
        size_t location_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < location_j_1_max__; ++j_1__) {
            vars__.push_back(location(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> scale = in__.vector_lb_constrain(0, K);
        size_t scale_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < scale_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            double py_0;
            (void) py_0;  // dummy to suppress unused var warning
            stan::math::initialize(py_0, DUMMY_VAR__);
            stan::math::fill(py_0, DUMMY_VAR__);
            ...
            validate_non_negative_index("lp_y0", "K", K);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> lp_y0(K);
            stan::math::initialize(lp_y0, DUMMY_VAR__);
            stan::math::fill(lp_y0, DUMMY_VAR__);
            stan::math::assign(lp_y0,log_pi);
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                stan::model::assign(lp_y0, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            (stan::model::rvalue(lp_y0, stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), "lp_y0") + (normal_log(0.0, get_base1(location, k, "location", 1), get_base1(scale, k, "scale", 1)) - normal_ccdf_log(0, get_base1(location, k, "location", 1), get_base1(scale, k, "scale", 1)))), 
                            "assigning variable lp_y0");
            }
            current_statement_begin__ = 89;
            stan::math::assign(lp_dp, log_sum_exp(lp_y0));
            current_statement_begin__ = 90;
            stan::math::assign(py_0, stan::math::exp(log_mix(pi_mix, lp_dp, (normal_log(0.0, location_spike, sigma_spike) - stan::math::log(.5)))));
            }
            // validate, write generated quantities
            current_statement_begin__ = 81;
            vars__.push_back(py_0);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "pi_mix";
        param_names__.push_back(param_name_stream__.str());
        size_t location_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < location_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "location" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t scale_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < scale_j_1_max__; ++j_1__) {
...
typedef model_dpHNormalSpike_namespace::model_dpHNormalSpike stan_model;
#ifndef USING_R
