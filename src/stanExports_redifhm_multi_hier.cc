...
#include "stanExports_redifhm_multi_hier.h"

RCPP_MODULE(stan_fit4redifhm_multi_hier_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_redifhm_multi_hier")
